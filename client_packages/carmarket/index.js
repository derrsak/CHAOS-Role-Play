...
mp.events.add('carmarket.car.sell.ans', (ans, price) => {
    ...
    switch (ans) {
        case 0:
            mp.notify.error('Вы не в своем т/с');
            break;
        case 1:
            mp.notify.error('Вы не у авторынка');
            break;
        case 2:
            mp.notify.error('Не удалось продать т/с');
            break;
        case 3:
            mp.busy.remove('carmarket.sellmenu');
            mp.notify.success(`Вы продали т/с за $${price}`);
            break;
    }
...
mp.events.add('carmarket.car.buy.ans', (ans, data) => {
    ...
    switch (ans) {
        case 0:
            mp.notify.error('Вы не в т/с авторынка');
            break;
        case 1:
            mp.notify.error('Не удалось приобрести т/с');
            break;
        case 2:
            mp.busy.remove('carmarket.buymenu');
        ...
        case 3:
            ...
            break;
        case 4:
            mp.notify.error('Достигнут лимит на т/с');
            break;
        case 5: // нельзя выдать ключи в инвентарь
            mp.notify.error(data.text);
            break;
    }
});
