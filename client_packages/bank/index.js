...
require("bank/phoneApp.js");

let numTransfer = null;
let accountNumTransfer = null;

let isInBankShape = false;

mp.events.add('bank.shape', (state) => {
    isInBankShape = state;
});

let pedModels = ['ig_bankman', 'u_m_m_bankman', 'a_f_y_business_04', 'a_f_y_business_02', 'a_f_y_business_01']
let npcScenario = 'WORLD_HUMAN_VALET';

mp.events.add('bank.npc.create', (peds) => {
