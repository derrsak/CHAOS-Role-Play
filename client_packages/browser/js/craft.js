var craft = new Vue({
    ...
    data: {
        ...
        // Кол-во топлива
        firewoodCount: 0,
        // id предмета дерева для подброски дров
        firewoodItemId: 131
    },
    computed: {
        currentType() {
    ...
    methods: {
        ...
        onClickDownFirewood() {
            var max = this.getMaterialCount(this.firewoodItemId);
        ...
        onClickAcceptFirewood() {
            ...
            if (this.firewoodCount > this.getMaterialCount(this.firewoodItemId)) return notifications.error(`Недостаточно дерева`);
