        ...
        menus: {
            ...
            "vehicle_inside": {
                ...
                handler(index) {
                    ...
                    if (item.text == 'Мегафон') {
                        mp.trigger(`vehicle.megafon.l`);
                        //mp.trigger(`vehicle.megafon`);
                        mp.trigger(`interaction.menu.close`);
                    }
            ...
            "vehicle_megafons": {
                name: "vehicle_megafons",
                items: [],
                handler(index) {
                    var item = this.items[index];
                    if (item.text == 'LSPD 1') {
                        mp.trigger(`callRemote`, `vehicle.megafon.lspd1`);
                        mp.trigger(`interaction.menu.close`);
                    }
                    if (item.text == 'LSPD 2') {
                        mp.trigger(`callRemote`, `vehicle.megafon.lspd2`);
                        mp.trigger(`interaction.menu.close`);
                    }
                    if (item.text == 'LSPD 3') {
                        mp.trigger(`callRemote`, `vehicle.megafon.lspd3`);
                        mp.trigger(`interaction.menu.close`);
                    }
                    if (item.text == 'LSSD 1') {
                        mp.trigger(`callRemote`, `vehicle.megafon.lssd1`);
                        mp.trigger(`interaction.menu.close`);
                    }
                    if (item.text == 'LSSD 2') {
                        mp.trigger(`callRemote`, `vehicle.megafon.lssd2`);
                        mp.trigger(`interaction.menu.close`);
                    }
                    if (item.text == 'LSSD 3') {
                        mp.trigger(`callRemote`, `vehicle.megafon.lssd3`);
                        mp.trigger(`interaction.menu.close`);
                    }
                    if (item.text == 'LSSD 4') {
                        mp.trigger(`callRemote`, `vehicle.megafon.lssd4`);
                        mp.trigger(`interaction.menu.close`);
                    }
                    if (item.text == 'FIB 1') {
                        mp.trigger(`callRemote`, `vehicle.megafon.fib1`);
                        mp.trigger(`interaction.menu.close`);
                    }
                    if (item.text == 'FIB 2') {
                        mp.trigger(`callRemote`, `vehicle.megafon.fib2`);
                        mp.trigger(`interaction.menu.close`);
                    }
                    if (item.text == 'FIB 3') {
                        mp.trigger(`callRemote`, `vehicle.megafon.fib3`);
                        mp.trigger(`interaction.menu.close`);
                    }
                    if (item.text == 'FIB 4') {
                        mp.trigger(`callRemote`, `vehicle.megafon.fib4`);
                        mp.trigger(`interaction.menu.close`);
                    }
                    if (item.text == 'GOV 1') {
                        mp.trigger(`callRemote`, `vehicle.megafon.gov1`);
                        mp.trigger(`interaction.menu.close`);
                    }
                    if (item.text == 'GOV 2') {;
                        mp.trigger(`callRemote`, `vehicle.megafon.gov2`);
                        mp.trigger(`interaction.menu.close`);
                    }
                    if (item.text == 'GOV 3') {
                        mp.trigger(`callRemote`, `vehicle.megafon.gov3`);
                        mp.trigger(`interaction.menu.close`);
                    }
                    if (item.text == 'GOV 4') {
                        mp.trigger(`callRemote`, `vehicle.megafon.gov4`);
                        mp.trigger(`interaction.menu.close`);
                    }
                    if (item.text == 'EMS 1') {
                        mp.trigger(`callRemote`, `vehicle.megafon.ems1`);
                        mp.trigger(`interaction.menu.close`);
                    }
                    if (item.text == 'ARMY 1') {
                        mp.trigger(`callRemote`, `vehicle.megafon.army1`);
                        mp.trigger(`interaction.menu.close`);
                    }
                    if (item.text == 'ARMY 2') {
                        mp.trigger(`callRemote`, `vehicle.megafon.army2`);
                        mp.trigger(`interaction.menu.close`);
                    }
                    if (item.text == 'ARMY 3') {
                        mp.trigger(`callRemote`, `vehicle.megafon.army3`);
                        mp.trigger(`interaction.menu.close`);
                    }
                    if (item.text == 'ARMY 4') {
                        mp.trigger(`callRemote`, `vehicle.megafon.army4`);
                        mp.trigger(`interaction.menu.close`);
                    }
                }
            },
            ...
            "player_ownmenu": {
                ...
                handler(index) {
                    ...
                    } else if (item.text == 'Прослушивающее устройство') {
                        mp.trigger(`interaction.menu.close`);
                        selectMenu.menu = selectMenu.menus["fibWiretapping"];
    ...
    watch: {
        ...
        faction(val) {
            if (!val) {
                ...
                this.deleteItem("player_ownmenu", "Прослушивающее устройство");
            ...
            if (val == 4) { // fib
                ...
                this.addItems("player_ownmenu", {
                    text: "Прослушивающее устройство",
                    icon: "headphones.svg"
                });
            } else {
                this.deleteItem("player_interaction", "FIB");
