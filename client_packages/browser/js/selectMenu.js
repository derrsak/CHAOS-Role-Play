        ...
        menus: {
                ...
                handler(eventName) {
                    ...
                    if (eventName == 'onItemSelected') {
                        if (e.itemName == 'Закрыть') {
                            ...
                            mp.trigger('casino.prizes.use', e.itemIndex);
                            selectMenu.show = false;
                        }
                    }
            ...
            "casinoCashier": {
                ...
                handler(eventName) {
                    ...
                    if (eventName == 'onItemSelected') {
                        if (e.itemName == 'Закрыть') {
                            selectMenu.show = false;
                        } else if (e.itemName == 'Купить фишки') {
                            mp.trigger('callRemote', 'casino.chips.menu.buy');
                        } else if (e.itemName == 'Продать фишки') {
                            mp.trigger('callRemote', 'casino.chips.menu.sell');
                        }
                    }
                    if (eventName == 'onBackspacePressed' || eventName == 'onEscapePressed') {
                        selectMenu.show = false;
                ...
                handler(eventName) {
                    ...
                    if (eventName == 'onItemSelected') {
                        if (e.itemName == 'Закрыть') {
                            ...
                            let count = parseInt(this.items[1].values[0]);
                            if (isNaN(count) || count < 1) return selectMenu.notification = 'Неверное количество';
                            selectMenu.show = false;
                            mp.trigger('callRemote', 'casino.chips.buy', count);
                        } else if (e.itemName == 'Продать') {
                            let count = parseInt(this.items[1].values[0]);
                            if (isNaN(count) || count < 1) return selectMenu.notification = 'Неверное количество';
                            selectMenu.show = false;
                            mp.trigger('callRemote', 'casino.chips.sell', count);
                        }
                    }
                    if (eventName == 'onBackspacePressed' || eventName == 'onEscapePressed') {
                        selectMenu.show = false;
            ...
            "questEditMenu": {
                ...
                items: [{
                    ...
                    {
                        text: "Добавить награду за выполнение"
                    },
                    {
                        text: "Добавить новую логику"
                    },
                    {
                ...
                handler(eventName) {
                    ...
                    if (eventName == 'onItemSelected') {
                        switch (e.itemName) {
                            case "Добавить награду за выполнение":
                                selectMenu.showByName("questAddPrize");
                                break;
                            case "Добавить новую логику":
                                selectMenu.showByName("questAddLogic");
                                break;
                            case "Удалить награду":
                                selectMenu.showByName("questDeletePrize");
                                break;
                            case "Удалить логику":
                                selectMenu.showByName("questDeleteLogic");
                                break;
                            case "Сохранить квест":
                                mp.trigger(`quest.editor.createQuest`, this.items[0].values[0], this.items[1].values[0], this.items[2].values[this.items[2].i]);
                                break;
                            case "Удалить квест":
                                mp.trigger(`quest.editor.deleteQuest`);
                                break;
                            case "Выйти из редактора":
                                mp.trigger(`quest.editor.close`);
                                break;
                        }
                    }
                }
            ...
            "questAddPrize": {
                name: "questAddPrize",
                header: "Добавить награду за выполнение",
                items: [{
                        text: "Предмет",
                    },
                    {
                ...
                handler(eventName) {
                    ...
                    if (eventName == 'onItemSelected') {
                        switch (e.itemName) {
                            case "Предмет":
                                selectMenu.showByName("questAddPrizeItem");
                                break;
                            case "Деньги":
                                selectMenu.showByName("questAddPrizeMoney");
                                break;
                            case "Назад":
                                selectMenu.showByName("questEditMenu");
                                break;
                        }
                    }
                }
            ...
            "questAddPrizeItem": {
                name: "questAddPrizeItem",
                header: "Добавить предмет в награду",
                items: [{
                        text: "ID предмета",
                        values: [''],
                        type: "editable",
                ...
                handler(eventName) {
                    ...
                    if (eventName == 'onItemSelected') {
                        switch (e.itemName) {
                            case "Сохранить":
                                mp.trigger(`quest.editor.addPrizeItem`, this.items[0].values[0], this.items[1].values[0]);
                                break;
                            case "Назад":
                                selectMenu.showByName("questAddPrize");
                                break;
            ...
            "questAddPrizeMoney": {
                name: "questAddPrizeMoney",
                header: "Добавить деньги в награду",
                items: [
                    {
                        text: "Количество",
                        values: [''],
                ...
                handler(eventName) {
                    ...
                    if (eventName == 'onItemSelected') {
                        switch (e.itemName) {
                            case "Сохранить":
                                mp.trigger(`quest.editor.addPrizeMoney`, this.items[0].values[0]);
                                break;
                            case "Назад":
                                selectMenu.showByName("questAddPrize");
                                break;
            ...
            "questAddLogic": {
                name: "questAddLogic",
                header: "Добавить новую логику",
                items: [
                    {
                        text: "Посещение места по координатам",
                    },
                    {
                        text: "Посещение определенного места"
                    },
                    {
                        text: "Поговорить с NPC"
                    },
                    {
                        text: "Купить предмет"
                    },
                    {
                        text: "Принести предмет"
                    },
                    {
                        text: "Назад"
                    }
                ...
                handler(eventName) {
                    ...
                    if (eventName == 'onItemSelected') {
                        switch (e.itemName) {
                            case "Посещение места по координатам":
                                selectMenu.showByName("questAddLogicEnterPos");
                                break;
                            case "Посещение определенного места":
                                selectMenu.showByName("questAddLogicEnterArea");
                                break;
                            case "Поговорить с NPC":
                                selectMenu.showByName("questAddLogicTalkNPC");
                                break;
                            case "Купить предмет":
                                selectMenu.showByName("questAddLogicBuyItem");
                                break;
                            case "Принести предмет":
                                selectMenu.showByName("questAddLogicGiveItem");
                                break;
                            case "Назад":
                                selectMenu.showByName("questEditMenu");
                                break;
            ...
            "questAddLogicEnterPos": {
                name: "questAddLogicEnterPos",
                header: "Посещение места по координатам",
                items: [
                    {
                        text: "Создать точку координат",
                    },
                    {
                        text: "ТП на точку координат",
                    },
                    {
                        text: "Сохранить"
                    },
                ...
                handler(eventName) {
                    ...
                    if (eventName == 'onItemSelected') {
                        switch (e.itemName) {
                            case "Создать точку координат":
                                mp.trigger(`quest.editor.addLogicEnterPos`);
                                break;
                            case "ТП на точку координат":
                                mp.trigger(`quest.editor.tpToLogicEnterPos`);
                                break;
                            case "Сохранить":
                                mp.trigger(`quest.editor.saveLogicEnterPos`, 1);
                                break;
                            case "Назад":
                                selectMenu.showByName("questAddLogic");
                                break;
            ...
            "questAddLogicEnterArea": {
                name: "questAddLogicEnterArea",
                header: "Посещение определенного места",
                items: [
                    {
                        text: "Место",
                        values: [''],
                ...
                handler(eventName) {
                    ...
                    if (eventName == 'onItemSelected') {
                        switch (e.itemName) {
                            case "Сохранить":
                                mp.trigger(`quest.editor.addLogicEnterArea`, 2, this.items[0].values[this.items[0].i]);
                                break;
                            case "Назад":
                                selectMenu.showByName("questAddLogic");
                                break;
            ...
            "questAddLogicTalkNPC": {
                name: "questAddLogicTalkNPC",
                header: "Поговорить с NPC",
                items: [
                    {
                        text: "ID NPC",
                        values: [''],
                ...
                handler(eventName) {
                    ...
                    if (eventName == 'onItemSelected') {
                        switch (e.itemName) {
                            case "Сохранить":
                                mp.trigger(`quest.editor.addLogicTalkNPC`, 3, this.items[0].values[0]);
                                break;
                            case "Назад":
                                selectMenu.showByName("questAddLogic");
                                break;
            ...
            "questAddLogicBuyItem": {
                name: "questAddLogicBuyItem",
                header: "Купить предмет",
                items: [
                    {
                        text: "ID ITEM",
                        values: [''],
                ...
                handler(eventName) {
                    ...
                    if (eventName == 'onItemSelected') {
                        switch (e.itemName) {
                            case "Сохранить":
                                mp.trigger(`quest.editor.addLogicBuyItem`, 4, this.items[0].values[0], this.items[1].values[0]);
                                break;
                            case "Назад":
                                selectMenu.showByName("questAddLogic");
                                break;
            ...
            "questAddLogicGiveItem": {
                name: "questAddLogicGiveItem",
                header: "Принести предмет",
                items: [
                    {
                        text: "ID ITEM",
                        values: [''],
                ...
                handler(eventName) {
                    ...
                    if (eventName == 'onItemSelected') {
                        switch (e.itemName) {
                            case "Сохранить":
                                mp.trigger(`quest.editor.addLogicGiveItem`, 5, this.items[0].values[0], this.items[1].values[0]);
                                break;
                            case "Назад":
                                selectMenu.showByName("questAddLogic");
                                break;
            ...
            "questDeletePrize": {
                name: "questDeletePrize",
                header: "Удалить награду",
                items: [],
                i: 0,
                j: 0,
                handler(eventName) {
                    ...
                    if (eventName == 'onItemSelected') {
                        if (e.itemName != 'Назад') mp.trigger(`quest.editor.deletePrize`, e.itemIndex);
                        selectMenu.showByName("questEditMenu");
                    }
                }
            },
            "questDeleteLogic": {
                name: "questDeleteLogic",
                header: "Удалить логику",
                items: [],
                i: 0,
                j: 0,
                handler(eventName) {
                    ...
                    if (eventName == 'onItemSelected') {
                        if (e.itemName != 'Назад') mp.trigger(`quest.editor.deleteLogic`, e.itemIndex);
                        selectMenu.showByName("questEditMenu");
                    }
                }
            },
            "npcEditorMenu": {
                ...
                items: [
                    ...
                    {
                        text: "Добавить выдаваемый квест"
                    },
                    {
                        text: "Удалить выдаваемый квест"
                    },
                    {
                        text: "Сохранить NPC"
                    },
                ...
                handler(eventName) {
                    ...
                    if (eventName == 'onItemSelected') {
                        switch (e.itemName) {
                            case "Позиция":
                                selectMenu.showByName("npcEditorPos");
                                break;
                            case "Другие настройки":
                                selectMenu.showByName("npcEditorOtherSettings");
                                break;
                            case "Добавить выдаваемый квест":
                                selectMenu.showByName("npcEditorAddQuest");
                                break;
                            case "Удалить выдаваемый квест":
                                selectMenu.showByName("npcEditorRemoveQuest");
                                break;
                            case "Сохранить NPC":
                                mp.trigger(`quest.editor.npc.createNpc`, this.items[0].values[0], this.items[1].values[0], this.items[2].i);
                                break;
                            case "Удалить NPC":
                                mp.trigger(`quest.editor.npc.deleteNpc`);
                                break;
                            case "Выйти из редактора":
                                mp.trigger(`quest.editor.npc.close`);
                                break;
                        }
                    }
                }
            ...
            "npcEditorPos": {
                ...
                handler(eventName) {
                    ...
                    if (eventName == 'onItemSelected') {
                        switch (e.itemName) {
                            case "Задать позицию":
                                mp.trigger(`quest.editor.npc.setPos`);
                                break;
                            case "ТП на позицию":
                                mp.trigger(`quest.editor.npc.tpToPos`);
                                break;
                            case "Назад":
                                selectMenu.showByName("npcEditorMenu");
                                break;
                        }
                    }
                }
            },
            "npcEditorOtherSettings": {
                name: "npcEditorOtherSettings",
                header: "Другие настройки NPC",
                items: [
                    {
                        text: "Модель",
                        values: [''],
                ...
                handler(eventName) {
                    ...
                    if (eventName == 'onItemSelected') {
                        switch (e.itemName) {
                            case "Сохранить":
                                mp.trigger(`quest.editor.npc.setOtherSettings`, this.items[0].values[0], this.items[1].values[this.items[1].i]);
                                break;
                            case "Назад":
                                selectMenu.showByName("npcEditorMenu");
                                break;
            ...
            "npcEditorAddQuest": {
                name: "npcEditorAddQuest",
                header: "Добавить выдаваемый квест",
                items: [
                    {
                        text: "Квест",
                        values: [''],
                ...
                handler(eventName) {
                    ...
                    if (eventName == 'onItemSelected') {
                        switch (e.itemName) {
                            case "Добавить":
                                mp.trigger(`quest.editor.npc.addQuest`, this.items[0].values[this.items[0].i]);
                                break;
                            case "Назад":
                                selectMenu.showByName("npcEditorMenu");
                                break;
            ...
            "npcEditorRemoveQuest": {
                name: "npcEditorRemoveQuest",
                header: "Удалить выдаваемый квест",
                items: [],
                i: 0,
                j: 0,
                handler(eventName) {
                    ...
                    if (eventName == 'onItemSelected') {
                        if (e.itemName != 'Назад') mp.trigger(`quest.editor.npc.removeQuest`, e.itemIndex);
                        selectMenu.showByName("npcEditorMenu");
                    }
                }
            },
            ...
            "lspdItems": {
                ...
                i: 0,
                j: 0,
                itemIds: [28, 24, 3, 45], // бесполезно вроде
                handler(eventName) {
                    var item = this.items[this.i];
                    var e = {
                        menuName: this.name,
            ...
            "fibWiretapping": {
                ...
                handler(eventName) {
                    ...
                    if (eventName == 'onItemSelected') {
                        if (e.itemName == "Подключиться") {
                            this.items[0].type = null;
                            this.items[1].text = "Отключиться";
                            mp.trigger('callRemote', 'wiretapping.add',  this.items[0].values[0]);
                        } else if (e.itemName == "Отключиться") {
                            this.items[0].type = "editable";
                            this.items[1].text = "Подключиться";
                            mp.trigger('callRemote', 'wiretapping.remove',  this.items[0].values[0]);
                        } else if (e.itemName == "Свернуть меню") {
                            selectMenu.show = false;
                        }
            ...
            "drugsBuyer": {
                ...
                handler(eventName) {
                    ...
                    if (eventName == 'onItemSelected') {
                        var data = {
                            index: e.itemIndex,
                            count: 1 // parseInt(e.itemValue)
                        };
                        if (e.itemName != "Закрыть") mp.trigger(`callRemote`, `bands.drugsBuyer.sell`, JSON.stringify(data));
                        selectMenu.show = false;
                    }
                }
            },
            "mafiaTransportation": {
                name: "mafiaTransportation",
                header: "Перевозка груза",
                items: [{
                        text: "Выбрать груз"
                    },
                    {
                ...
                handler(eventName) {
                    ...
                    if (eventName == 'onItemSelected') {
                        if (e.itemName == 'Выбрать груз') {
                            selectMenu.showByName("mafiaTransportationList");
                        } else if (e.itemName == 'Закрыть') {
                            selectMenu.show = false;
                        }
                    } else if (eventName == 'onBackspacePressed')
            ...
            "mafiaTransportationList": {
                name: "mafiaTransportationList",
                header: "Начать перевозку",
                items: [{
                        text: "Деньги"
                    },
                    {
                ...
                handler(eventName) {
                    ...
                    if (eventName == 'onItemSelected') {
                        if (e.itemName == "Назад") return selectMenu.showByName("mafiaTransportation");

                        selectMenu.show = false;
                        mp.trigger(`callRemote`, `transportations.start`);
                    } else if (eventName == 'onBackspacePressed')
                        selectMenu.showByName("mafiaTransportation");
                }
            },
            "dmvMenu": {
                name: "dmv",
                    ...
                    if (eventName == 'onItemSelected') {
                        ...
                        switch (e.itemName) {
                            ...
                            case 'Задний бампер':
                                ...
                                break;
                            case 'Нижний спойлер': // for swapModType cars
                                mp.trigger('tuning.defaultMenu.show', 'rearBumper');
                                break;
                            case 'Пороги':
                            ...
                            case 'Покрасочные работы':
                                ...
                                break;
                            case 'Колеса':
                                mp.trigger('tuning.wheels.groups');
                                //mp.trigger(`callRemote`, `loadwheelbd`);
                                break;
                            case 'Тонировка':
                                mp.trigger('tuning.defaultMenu.show', 'windowTint');
                                break;
                            case 'Фары':
                                mp.trigger('tuning.xenmenu.show',);
                                break;
                            case 'Номерные знаки':
                                mp.trigger('tuning.defaultMenu.show', 'plateHolder');
                                break;
                            case 'Неон':
                                mp.trigger('tuning.neonmenu.show');
                                break;
            ...
            "tuningColors": {
                ...
                handler(eventName) {
                    ...
                    if (eventName == 'onItemSelected') {
                        if (e.itemName == 'Назад') {
                            mp.trigger('tuning.modType.set', '-1');
                            mp.trigger('tuning.menu.show');
                            mp.trigger('tuning.params.set');
                        } else if (e.itemName == 'Основной цвет') {
                            mp.trigger('tuning.colorpicker.show', 1); 
                            selectMenu.show = false;
                        } else if (e.itemName == 'Дополнительный цвет') {
                            mp.trigger('tuning.colorpicker.show', 2);
                            selectMenu.show = false;
                        }
                    }
                    if (eventName == 'onEscapePressed' || eventName == 'onBackspacePressed') {
                ...
                handler(eventName) {
                    ...
                    if (eventName == 'onItemSelected') {
                        if (e.itemName == 'Назад') {
                            mp.trigger('tuning.menu.show');
                            selectMenu.show = false;
                        } else if (e.itemName == 'Спорт (0-17)') {
                            mp.trigger(`callRemote`, `loadwheelbd1`);
                            mp.trigger('tuning.mod.setw', 23, -1);
                            selectMenu.show = false;
                        } else if (e.itemName == 'Лоурайдер (18-30)') {
                            mp.trigger(`callRemote`, `loadwheelbd2`);
                            mp.trigger('tuning.mod.setw', 23, 18);
                            selectMenu.show = false;
                        } else if (e.itemName == 'Седан (31-39)') {
                            mp.trigger(`callRemote`, `loadwheelbd3`);
                            mp.trigger('tuning.mod.setw', 23, 31);
                            selectMenu.show = false;
                        } else if (e.itemName == 'от Benny (40-51)') {
                            mp.trigger(`callRemote`, `loadwheelbd4`);
                            mp.trigger('tuning.mod.setw', 23, 40);
                            selectMenu.show = false;
                        } else if (e.itemName == 'Эксклюзив (от 52)') {
                            mp.trigger(`callRemote`, `loadwheelbd5`);
                            mp.trigger('tuning.mod.setw', 23, 52);
                            selectMenu.show = false;
                        }
                    }
                    if (eventName == 'onEscapePressed' || eventName == 'onBackspacePressed') {
            ...
            "tuningDefault": {
                ...
                handler(eventName) {
                    ...
                    if (eventName == 'onItemFocusChanged') {
                        if (e.itemName == 'Назад') return mp.trigger('tuning.params.set');
                        if (e.itemName == 'Отсутствует') return mp.trigger('tuning.mod.set', 55, 0);
                        if (e.itemName == 'Слабое затемнение') return mp.trigger('tuning.mod.set', 55, 3);
                        if (e.itemName == 'Среднее затемнение') return mp.trigger('tuning.mod.set', 55, 2);
                        if (e.itemName == 'Полное затемнение') return mp.trigger('tuning.mod.set', 55, 1);
                        let index = e.itemIndex - 1;
                    ...
                    if (eventName == 'onItemSelected') {
                        ...
                        else if (e.itemName == 'Отсутствует') {
                            if (item.values[0] == 'уст.') return selectMenu.notification = 'Этот элемент уже установлен';
                            mp.trigger('tuning.buy', -1, 0);
                            mp.trigger('tuning.modType.set', '-1');
                            mp.trigger('tuning.menu.show');
                        }
                        else if (e.itemName == 'Слабое затемнение') {
                            if (item.values[0] == 'уст.') return selectMenu.notification = 'Этот элемент уже установлен';
                            mp.trigger('tuning.buy', -1, 3);
                            mp.trigger('tuning.modType.set', '-1');
                            mp.trigger('tuning.menu.show');
                        }
                        else if (e.itemName == 'Среднее затемнение') {
                            if (item.values[0] == 'уст.') return selectMenu.notification = 'Этот элемент уже установлен';
                            mp.trigger('tuning.buy', -1, 2);
                            mp.trigger('tuning.modType.set', '-1');
                            mp.trigger('tuning.menu.show');
                        }
                        else if (e.itemName == 'Полное затемнение') {
                            if (item.values[0] == 'уст.') return selectMenu.notification = 'Этот элемент уже установлен';
                            mp.trigger('tuning.buy', -1, 1);
                            mp.trigger('tuning.modType.set', '-1');
                            mp.trigger('tuning.menu.show');
                        }
                        else {
            ...
            "tuningDefaultW": {
                ...
                handler(eventName) {
                    ...
                    if (eventName == 'onItemFocusChanged') {
                        if (e.itemName == 'Назад') {
                            mp.trigger('tuning.params.set');
                        } else if (e.itemName == 'Стандартные') {
                            mp.trigger('tuning.mod.setw', 23, -1);
                        } else {
                            mp.trigger('tuning.mod.setw', 23, parseInt(e.itemName.match(/\d+/)[0]));
                        }
                    }
                    if (eventName == 'onItemSelected') {
                        if (e.itemName == 'Назад') {
                            ...
                            mp.trigger('tuning.buy.wheels', -1);
                        } else {
                            mp.trigger('tuning.buy.wheels', parseInt(e.itemName.match(/\d+/)[0]));
                        }
                    }
                    if (eventName == 'onEscapePressed' || eventName == 'onBackspacePressed') {
                        mp.trigger('tuning.wheels.groups');
            ...
            "supermarketFood": {
                ...
                handler(eventName) {
                    ...
                    if (eventName == 'onItemSelected') {
                        ...
                        if (e.itemName == 'Батончик шоколада') {
                ...
                handler(eventName) {
                    ...
                    if (eventName == 'onItemSelected') {
                        if (e.itemName == 'Закрыть') {
                            ...
                            mp.trigger('callRemote', 'cases.prizes.use', item.id);
                            selectMenu.show = false;
                        }
                    }
                    if (eventName == 'onBackspacePressed' || eventName == 'onEscapePressed') {
