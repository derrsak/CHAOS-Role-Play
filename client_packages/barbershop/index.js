...
let pedModels = ['ig_jay_norris', 'a_f_y_indian_01', 'a_f_y_genhot_01'];
let npcScenario = 'WORLD_HUMAN_VALET';

mp.events.add('barbershop.npc.create', (peds) => {
