...
let pedModels = ['s_m_y_shop_mask'];
let npcScenario = 'WORLD_HUMAN_AA_SMOKE'; // WORLD_HUMAN_AA_SMOKE (более спокойно) . WORLD_HUMAN_SMOKING (часто курит аля по блатному)
...
mp.events.add('masks.npc.create', (ped) => {
    ped.model = pedModels[0];
    ped.defaultScenario = npcScenario;
