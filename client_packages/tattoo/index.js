...
let pedModels = ['u_m_y_tattoo_01'];
let npcScenario = 'WORLD_HUMAN_VALET';

mp.events.add({
    'tattoo.npc.create': (peds) => {
    ...
    'tattoo.buy.ans': (ans) => {
        ...
        switch (ans) {
            ...
            case 4:
                ...
                break;
            case 5:
                mp.callCEFV(`selectMenu.notification = 'Татуировка не подходит для вас'`);
                break;
        }
    },
