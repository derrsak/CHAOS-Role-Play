...
module.exports = {
    "/gethashfront": {
        access: 6,
        description: "Узнать хеш объекта перед игроком (вывод в консоль)",
        handler: (player, args, out) => {
            player.call(`world.objects.getHash`, []);
        }
    },
    "/testmath": {
        access: 6,
