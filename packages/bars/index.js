...
module.exports = {
    ...
    async init() {
        ...
        console.log(`[BARS] Загружено баров: ${i}`);
    },
    getInfo() {
        return this.alcohol;
    },
    addBar(barInfo) {
        let colshape = mp.colshapes.newSphere(barInfo.x, barInfo.y, barInfo.z, this.shapeRange);
        colshape.isBar = true;

        let marker = mp.markers.new(1, new mp.Vector3(barInfo.x, barInfo.y, barInfo.z - 1), this.shapeRange, {
