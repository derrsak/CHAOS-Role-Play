...
module.exports = {
    ...
    "mafia.cuffs": (player, data) => {
        ...
        if (!rec.cuffs) {
            if (!factions.isMafiaFaction(character.factionId) && !factions.isBandFaction(character.factionId)) return notifs.error(player, `Вы не член мафии/банды`, header);
            ...
            if (!factions.isMafiaFaction(character.factionId) && !factions.isBandFaction(character.factionId) && !factions.isPoliceFaction(character.factionId) && !factions.isFibFaction(character.factionId)) return notifs.error(player, `Вы не член мафии/банды/порядка`, header);
