...
module.exports = {
    ...
    maxSalaryMultiplier: 0.3, // множитель зарплаты
    ...
    getRepairPriceMultiplier(vehicle) {
        let price = vehicle.properties.price; // множитель в зависимости от цены автомобиля
        let multiplier;
    ...
    repairVehicle(vehicle) {
        try {
            ...
            console.log(`[CARSERVICE] Error (repairVehicle): ${err}`);
        }
    },
    getBizParamsById(id) {
